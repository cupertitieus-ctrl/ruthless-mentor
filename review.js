...
if (form) {
    form.addEventListener('submit', async (e) => {
        ...
        const steps = [
            { pct: 5, text: 'Uploading your manuscript...' },
            { pct: 10, text: 'Reading through every page...' },
            { pct: 16, text: 'Getting into the story...' },
            { pct: 22, text: 'Critiquing the author\'s voice...' },
            { pct: 28, text: 'Scanning for repeat words...' },
            { pct: 34, text: 'Counting every "just" and "really"...' },
            { pct: 39, text: 'Checking prose quality...' },
            { pct: 44, text: 'Hunting for broken metaphors...' },
            { pct: 49, text: 'Looking for purple prose...' },
            { pct: 54, text: 'Grading your characters...' },
            { pct: 59, text: 'Checking for Mary Sues...' },
            { pct: 63, text: 'Evaluating story mechanics...' },
            { pct: 67, text: 'Testing the dialogue...' },
            { pct: 71, text: 'Looking for plot holes...' },
            { pct: 75, text: 'Running the depth check...' },
            { pct: 79, text: 'Pulling specific passages...' },
            { pct: 83, text: 'Writing line-level callouts...' },
            { pct: 86, text: 'Finding what works (yes, there are good parts)...' },
            { pct: 89, text: 'Drafting your final verdict...' },
            { pct: 92, text: 'Deciding if we\'d buy this in a bookstore...' },
            { pct: 94, text: 'Polishing the report...' },
            { pct: 96, text: 'Adding the finishing touches...' },
