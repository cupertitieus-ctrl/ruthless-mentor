...
**The word-of-mouth factor:** When a reader finishes this book, what would they actually tell a friend about it in one sentence? Be specific — write the actual sentence a real kid or reader would say. "Dude, this book has a hamster that steals nachos and it's HILARIOUS" is a word-of-mouth hit. "It was pretty good, I guess" is a word-of-mouth dead end. Word of mouth is how books actually spread — not marketing, not ads, not algorithms. Real people telling real friends "you have to read this." Does this manuscript give a reader something specific to say? A bizarre premise they can't wait to describe, a character moment that made them gasp, a twist they want to see someone else's face during, a line so funny they'll quote it. Name the exact thing in this book that creates a shareable moment — or be honest that there isn't one yet and say specifically what needs to sharpen to create one. 3-6 sentences.
