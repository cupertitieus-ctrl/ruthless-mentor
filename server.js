...
app.get(['/rmeditor', '/rework-editor'], (req, res) => {
  res.sendFile(path.join(__dirname, 'rmeditor.html'));
});
...
**The size calculation:** Is this a broad, moderate, or niche concept? WHY? Justify it with a specific observation about the concept — who the natural audience is and whether the hook is universal or specific. Do NOT give specific numbers of any kind — no sales projections, no audience counts (don't say "millions of kids," "hundreds of thousands of families," "tens of thousands of readers," or any other numeric estimate). Describe the audience in qualitative terms only ("every kid who's ever had a class pet," "a small and specific group of families living through a hard diagnosis," "a wide swath of middle-grade readers who like funny mysteries"). Numbers are speculation you don't have data for. Stick to describing WHO the audience is and whether the concept is broad or niche, not HOW MANY. 3-6 sentences.

**What makes this book stand out:** The honest look at the book's differentiator. What is the specific thing about this manuscript that could make a reader pick it up over another book in the same space — OR the specific gap where there isn't enough differentiation yet. Name the exact craft elements (voice, humor, concept, premise freshness, character specificity) doing the work or failing to do the work. For books that stand out well, celebrate specifically what's working. For books that don't yet, be specific about what needs to sharpen.

FORBIDDEN in this subsection:
- No book title references. Do not name specific comp books or authors.
- No specific micro-niche market claims like "there's a sea of classroom pet books" or "the school mystery genre is crowded with detective kid stories" or "chapter books about hamsters are everywhere." You cannot verify these micro-niche markets and often exaggerate or invent them. Describe what makes the book stand out in PURE craft terms (voice, concept, specificity) without claiming to know what else exists in the micro-category.
- No "the market is saturated with X" claims about specific subgenres you cannot verify.

The standout analysis should be about the BOOK ITSELF — its voice, its specificity, its premise freshness, its hook — not about fabricated claims about what the competitive market looks like. 3-6 sentences.
...
- If NO title was provided in the manuscript metadata, do NOT make one up. Either skip the fake quote and describe the shareable hook in pure craft terms, OR write the fake quote referencing "this book" / "it" without naming any title.
- Getting the title wrong is a credibility-destroying mistake on the level of fabricating a quote from the manuscript. Check the metadata before you write the sentence.

Example of the right format (with a real title): "Picture a kid holding this book up in the lunch line. 'Dude, you have to read *Don't Trust a Nacho Hamster*, the class pet literally steals nachos and bathes in them like it's a spa day.' That's a word-of-mouth hit — specific, weird, and easy to describe in one breath."

Does this manuscript give a reader something specific to say? A bizarre premise they can't wait to describe, a character moment that made them gasp, a line so funny they'll quote it? Name the exact thing in this book that creates a shareable moment — or be honest that there isn't one yet and say specifically what needs to sharpen to create one. 3-6 sentences.
...
- NEVER use vague industry jargon. Banned phrases include: "emotional resonance", "emotional stakes", "tonal depth", "thematic weight", "narrative gravity", "visceral impact", "deadpan delivery", "wry authorial distance", "subtextual layering", "interiority", "tonal register", "authorial remove", "lyrical density." Real people don't talk like that. Use plain English. If you mean the narrator tells absurd stuff in a flat tone that makes it funnier, say exactly that — don't call it "deadpan delivery." If you mean the writing has a steady rhythm and beautiful word choices, say exactly that — don't call it "lyrical density." Every craft concept should be described in words a non-writer would immediately understand.
...
const COUPONS = {
  ...
  'TAKE5': { type: 'free', discount: 100, maxUses: 5, message: 'Tester code applied — this review is free!' },
